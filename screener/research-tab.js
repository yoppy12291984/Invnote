export function mount(root){
 ...
 <a href="research-lab/index.html?v=1.1" target="_blank" rel="noopener">投資調査だけを別画面で開く</a><p id="researchLoadState" role="status">投資調査を読み込み中…</p></div>
 <iframe id="researchFrame" title="投資調査：候補・反証・購入検討" src="research-lab/index.html?v=1.1" loading="lazy" style="width:100%;height:900px;display:block;border:0;border-radius:10px;background:var(--sur)"></iframe>`;
